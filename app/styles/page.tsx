      ...
      <main className="overflow-x-hidden">
        <div className="relative px-6 lg:px-0 flex flex-col mx-auto max-w-[80rem] mt-16 lg:mt-28 pb-20">
          <div
            ...
            style={{ background: 'linear-gradient(184deg, #FEFFFE 23.18%, #99FF89 62.74%, #FFd600 92%)'}}
          />
          <div className="mb-12 z-10">
            <h1 className="text-3xl font-bold text-black sm:text-[3.375rem] break-words">57 Popular icon categories</h1>
            <p className="mx-auto mt-2 sm:mt-7 text-lg leading-8 text-grey-500">
              Houston Provides 7 popular styles to fulfill your creative needs. Explore stroke, twotone, duotone, solid, bulk icon styles.
            </p>
          </div>
        </div>
        <div className="py-[55px] bg-[#F8F8F8]">
          <StyleIconCard
            styleName="Stroke"
            description="HoustonIcons&apos;; stroke icons showcas a sleek and modern aesthetic with a single, consistent oulined path. Their minimalist design is adaptable to various backgrounds and scalable dimensions. Ideal for digital interfaces, these vector-based icons allow customization where any color applied affects only the stroke, preserving a clean and personalized visual appeal."
        ...
        <div className="py-[55px]">
          <StyleIconCard
              styleName="Duotone"
              description="HoustonIcons&apos;  duotone icons feature a sophisticated dual-color design with two layers-primary and secondary colors, where the secondary color defaults to 40% opaticy. This design uniquely affects both the stroke and fill of the icons, allowing users to apply colors to both layers for a customizable and dynamic appearance."
