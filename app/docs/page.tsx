      ...
      <div className="bg-slate-50 dark:bg-zinc-900 dark:text-zinc-50 antialiased font-sans min-h-screen transition-[grid-template-columns] duration-300 ease-in-out">
        ...
        <div className="mx-auto flex max-w-[90rem]">
          ...
          <Article>
            ...
            <Paragraph>
              Thousands of designers, developers, and content creators use
              Houston Pro for unlimited personal and commercial projects, making
              it one of the most versatile and user-friendly icon libraries
              available.
            </Paragraph>
            <H2 id="features">
            ...
            <Paragraph>
              ...
              making it the perfect choice for designers, developers, and
              content creators.
            </Paragraph>
            <H2 id="how-to-use-houston-icons">
              How to use Houston Icons{' '}
              <Anchor href="#how-to-use-houston-icons" />
            </H2>
            <Paragraph>
              To use Houston Icons, simply install the icon library and import
              it into your project. You can then use the icons in your user
              interface by selecting the desired icon and customizing it to fit
              your needs.
            </Paragraph>
            <Paragraph>
          ...
          <OnThisPage title="On this page">
            ...
            <Link href="how-to-use-houston-icons">
              How to use Houston Icons
            </Link>
          </OnThisPage>
        </div>
