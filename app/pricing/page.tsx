        ...
        <div className="mx-auto mt-12 flex max-w-6xl flex-col items-center px-6 pb-20">
          ...
          <div className="grid w-max grid-cols-1 gap-5 md:grid-cols-2 md:gap-5 lg:grid-cols-3 lg:gap-6">
            <div className="w-[19rem] h-full px-6 py-8 bg-gray-50/50 border border-grey-200 rounded-lg lg:w-auto">
              ...
              <p className="min-h-[4rem] mb-3 text-grey-500 text-md">Essential icons for solo developers.</p>
              ...
              <ul className="max-w-[366px]">
                ...
                <li className="flex items-center py-5 border-t border-grey-100">
                  ...
                  <p className="font-xs font-normal sm:text-md ml-4">
                    NPM package for easy integration into React/Next/React Native projects
                  </p>
                </li>
                <li className="flex items-center py-5 border-t border-grey-100">
                  <svg
            ...
            <div className="w-[19rem] h-full px-6 py-8 border border-grey-200 rounded-lg lg:w-auto bg-gray-50/50">
              <h4 className="text-5xl mb-4 text-softis-mid font-bold">Startup</h4>
              <p className="min-h-[4rem] mb-3 text-grey-500 text-md">Collaboration tools for small teams.</p>
              <div className="flex items-center h-[5.5rem] mb-6">
                <h3 className="text-4xl">$</h3>
            ...
            <div className="w-[19rem] h-full px-6 py-8 bg-gray-50/50 border border-grey-200 rounded-lg lg:w-auto">
              ...
              <p className="min-h-[4rem] mb-3 text-grey-500 text-md">Unlimited projects for large teams.</p>
              <div className="flex items-center h-[5.5rem] mb-6">
                <h3 className="text-4xl">$</h3>
              ...
              <ul className="max-w-[366px]">
                ...
                <li className="flex items-center py-5 border-t border-grey-100">
                  ...
                  <p className="font-xs font-normal sm:text-md ml-4">
                    Exclusive Figma plugin for quick and customization directly in Figma. <strong>(Coming Soon!)</strong>
                  </p>
                </li>
                <li className="flex items-center py-5 border-t border-grey-100">
                  <svg
