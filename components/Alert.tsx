  ...
  return (
    <div className="mt-6">
      ...
      <Toast.Provider label="Notification" swipeDirection="up">
        ...
        <Toast.Root
          className="bg-black text-white border-2 border-neutral-700 shadow-lg w-[356px] h-[53px] flex items-center gap-[6px] rounded-lg p-4 text-sm data-[state=delayed-open]:data-[side=top]:animate-slideDownAndFade data-[state=delayed-open]:data-[side=right]:animate-slideLeftAndFade data-[state=delayed-open]:data-[side=left]:animate-slideRightAndFade data-[state=delayed-open]:data-[side=bottom]:animate-slideUpAndFade"
          open={isOpenAlert}
        ...
        <Toast.Viewport className="fixed flex flex-col p-[25px] gap-[10px] max-w-[100vw] m-0 list-none z-[2147483647] outline-none top-[50px] left-1/2 -translate-x-1/2" />
      </Toast.Provider>
    </div>
  )
}
